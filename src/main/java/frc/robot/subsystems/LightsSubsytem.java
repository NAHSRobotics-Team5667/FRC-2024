...
public class LightsSubsystem extends SubsystemBase {
    ...
    private period currentPeriod = LightsSubsystem.period.DISABLED;

    public LightsSubsystem.period getPeriod() {
     ...
     */
    public void setPeriod(LightsSubsystem.period p) {
        currentPeriod = p;
    ...
    public class Light_Scheduler {
        ...
        LightEffect[] tests = new LightEffect[] {
                ...
                () -> {
                    LightsSubsystem.this.cylon(60, 255, 1);
                }
        };

        public Light_Scheduler() {
            this.default_disabled = () -> {
                LightsSubsystem.this.cylon_but_two(2, 255, 1, 24, 255);
            };
            this.defualt_teleop = () -> {
                LightsSubsystem.this.rainbow(2);
            };
            this.defualt_auto = () -> {
                LightsSubsystem.this.carnival(new Color[] { teamColor, Color.kBlack, Color.kWhite, Color.kBlack }, 3);
            };
        ...
        public void setDefaultLightEffect() {
            period period = LightsSubsystem.this.getPeriod();
            switch (period) {
                case DISABLED:
